...
public class textToXMLApp extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtFileField, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addComponent(folderField, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtFileField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(browseBtn1))
                .addGap(58, 58, 58)
                .addComponent(OuputLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void acceptBtnActionPerformed(java.awt.event.ActionEvent evt) throws IOException {   
    	...
    	for(File i : textFileChooser.getSelectedFiles())
    	{
    		...
    		//Splitting differs on operating systems. Avoids problem from different path format on windows.
    		if(OS.equals("win"))
    		{
    			temp = outputName.split("\\\\");
    			outputName = folderChooser.getSelectedFile().toString() + "\\\\" + temp[temp.length-1];
    		}
    		...
    		//Exits after converting; assuming that is what the user wants. Erase otherwise.
    		exitAction();
    	}
    }                                         
    ...
    private void browseBtn1ActionPerformed(java.awt.event.ActionEvent evt) {                                          
    	...
    	if(returnValue == JFileChooser.APPROVE_OPTION)
    	{
    		...
    		txtFileField.setText(textFileChooser.getSelectedFiles()[0].toString());
    		for(int i=1; i<textFileChooser.getSelectedFiles().length; i++)
    		{
    			String[] path;
    			if(OS.equals("win"))
    			{
    				path = textFileChooser.getSelectedFiles()[i].toString().split("\\\\");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(textToXML.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
